...
blue_image = pygame.image.load('pic/blue.png').convert_alpha()
red_image = pygame.image.load('pic/red.png').convert_alpha()
green_image = pygame.image.load('pic/green.png').convert_alpha()
pink_image = pygame.image.load('pic/pink.png').convert_alpha()
eraser_image = pygame.image.load('pic/eraser.png').convert_alpha()
